                    ...
                    <div class="px-4 py-5 bg-white sm:p-6 space-y-4 shadow-custom">
                        ...
                        <div class="col-span-6 mb-4 hidden" data-driver="{{ \App\Enums\StrategyKey::Webdav }}">
                            ...
                            <div class="col-span-6">
                                ...
                                <x-switch id="webdav-configs[proxy]" name="configs[proxy]" value="1"></x-switch>
                            ...
                            <div class="col-span-3 sm:col-span-2 mt-4">
                                ...
                                <x-switch id="webdav-configs[proxy_cache]" name="configs[proxy_cache]" value="1"></x-switch>
                            ...
                            <div class="col-span-3 sm:col-span-2 mt-4">
                                ...
                                <x-input type="number" min="1" max="10000" name="configs[proxy_cache_limit]" id="webdav-configs[proxy_cache_limit]" value="100"></x-input>
                        ...
                        <div class="col-span-6 mb-4 hidden" data-driver="{{ \App\Enums\StrategyKey::R2 }}">
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                <label for="r2-configs[url]" class="block text-sm font-medium text-gray-700"><span class="text-red-600">*</span>访问域名</label>
                                <x-input type="url" name="configs[url]" id="r2-configs[url]" placeholder="请输入 R2 自定义域名或 r2.dev 域名" />
                            ...
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                ...
                                <x-input type="text" name="configs[queries]" id="r2-configs[queries]" placeholder="请输入 url 额外参数" />
                            </div>
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                ...
                                <x-input type="text" name="configs[access_key_id]" id="r2-configs[access_key_id]" placeholder="请输入 R2 Access Key ID" />
                            </div>
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                ...
                                <x-input type="password" name="configs[secret_access_key]" id="r2-configs[secret_access_key]" placeholder="请输入 R2 Secret Access Key" />
                            </div>
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                <label for="r2-configs[endpoint]" class="block text-sm font-medium text-gray-700"><span class="text-red-600">*</span>S3 API 端点</label>
                                <x-input type="url" name="configs[endpoint]" id="r2-configs[endpoint]" placeholder="https://账户ID.r2.cloudflarestorage.com" />
                            </div>
                            <div class="col-span-3 sm:col-span-2 mb-4">
                                <label for="r2-configs[bucket]" class="block text-sm font-medium text-gray-700"><span class="text-red-600">*</span>储存桶名称</label>
                                <x-input type="text" name="configs[bucket]" id="r2-configs[bucket]" placeholder="请输入 R2 Bucket 名称" />
                            </div>
                        </div>
                    </div>
